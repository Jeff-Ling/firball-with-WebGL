...
class ShaderProgram {
  ...
  unifPerlinPct: WebGLUniformLocation;
  ...
  constructor(shaders: Array<Shader>) {
    ...
    this.unifPerlinPct  = gl.getUniformLocation(this.prog, "u_PerlinPct");
    this.unifFBMPct     = gl.getUniformLocation(this.prog, "u_FBMPct");
  ...
  setPerlinPct(PerlinPct: number)
  {
    this.use();
    if (this.unifPerlinPct !== -1)
    {
      gl.uniform1f(this.unifPerlinPct, PerlinPct);
    }
  }
